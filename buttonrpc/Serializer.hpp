...
public:
    ...
    // we can see the meaning of the param m_curpos from here, meaning position
...
{
public:
    // default byteorder is LittleEndian.
...
public:
	...
	int size(){
		return m_iodevice.size(); // StreamBuffer inherit vector<char>, size() is the function of class vector
	}
